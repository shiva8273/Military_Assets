...
export default function Expenditures() {
  ...
  const validate = () => {
    ...
    if (!form.reason.trim())
      errs.reason = "Reason/Details for expenditure is required";
    setErrors(errs);
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      render: (val) => (
        <span className="font-semibold text-red-400 tabular-nums">-{val}</span>
      ),
    },
    {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Log consumed ammunition, demilitarized assets, or write-offs
          </p>
        </div>
      ...
      <Modal
        ...
        title="Record Equipment Expenditure"
      >
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ ...form, expenditure_date: e.target.value })
              }
