...
import { getOpeningBalances, createOpeningBalance, getBases, getEquipmentTypes } from '../services/api'
...
export default function OpeningBalances() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Create Opening Balance">
