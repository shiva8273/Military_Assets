...
// ── Response interceptor: friendly errors ────────────────────────────────────
api.interceptors.response.use(
  ...
  (error) => {
    ...
    if (!error.response) {
      message = 'Unable to connect to the server. Please check the API is running.'
    } else if (status === 400) {
...
// Equipment Types
// ─────────────────────────────────────────────────────────────────────────────
export const getEquipmentTypes   = (params) => api.get('/api/eq_type/', { params })
export const createEquipmentType = (data)   => api.post('/api/eq_type/', data)
export const updateEquipmentType = (id, data) => api.patch(`/api/eq_type/${id}/`, data)

// ─────────────────────────────────────────────────────────────────────────────
// Opening Balances
// ─────────────────────────────────────────────────────────────────────────────
export const getOpeningBalances   = (params) => api.get('/api/opening-balances/', { params })
export const createOpeningBalance = (data)   => api.post('/api/opening-balances/', data)
...
// Expenditures
// ─────────────────────────────────────────────────────────────────────────────
export const getExpenditures   = (params) => api.get('/api/expenditures/', { params })
